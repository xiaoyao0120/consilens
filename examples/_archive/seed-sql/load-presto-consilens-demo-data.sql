-- Presto seed data for Consilens examples.
-- Presto 0.284+ compatible
...
--
-- Note: Presto is a query engine, not a storage engine.
...
--   - sequence function for sequence generation
...
-- =========================================================
-- sequence helper using sequence function
-- =========================================================
...
SELECT 'presto.memory.consilens_demo.consilens_performance_demo_table' AS check_name,
