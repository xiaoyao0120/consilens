...
@Repository
public class MybatisPlusTaskCommandRepository implements TaskCommandRepository {

    private final TaskCommandService taskCommandService;

    public MybatisPlusTaskCommandRepository(TaskCommandService taskCommandService) {
