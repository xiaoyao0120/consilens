...
@Repository
public class MybatisPlusServerNodeRepository implements ServerNodeRepository {

    private final ServerNodeService serverNodeService;

    public MybatisPlusServerNodeRepository(ServerNodeService serverNodeService) {
