...
@Service
public class DefaultServerTopologyService implements ServerTopologyService {
    ...
    public DefaultServerTopologyService(ServerNodeQueryService serverNodeQueryService,
